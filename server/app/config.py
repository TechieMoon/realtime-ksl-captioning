...
class Settings(BaseSettings):
    ...
    hf_model_id: str | None = "Seoyoung07/korean-sign-word-classifier-mediapipe"
    hf_model_revision: str = "main"
    hf_token: str | None = None
    model_device: str = "cpu"
    caption_auth_token: str | None = None
    model_top_k: int = Field(default=5, ge=1, le=20)
    sequence_target_fps: float = Field(default=15.0, gt=0, le=60)
    ...
    max_segment_frames: int = Field(default=180, ge=1, le=600)
